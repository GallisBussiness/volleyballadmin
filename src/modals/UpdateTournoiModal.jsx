...
const toDateT = (arr= []) => arr.map(r => parseISO(r))
...
const UpdateTournoiModal = ({ isOpen, onResolve, onReject,tournoi }) => {
  ...
  // });
    ...
    const defaultValues = {_id: tournoi?._id,nom: tournoi?.nom, date: tournoi?.date,dateDeFermiture:tournoi?.dateDeFermiture ,genre: tournoi?.genre,type: tournoi?.type,
      nb_equipe_tableau_principal: tournoi?.nb_equipe_tableau_principal,
      dont_w_c_p: tournoi?.dont_w_c_p,
      dont_places_r_q: tournoi?.dont_places_r_q,
      nb_eq_en_q: tournoi?.nb_eq_en_q,
      dont_w_e_q: tournoi?.dont_w_e_q,
      nb_t_norme: tournoi?.nb_t_norme,
      date_qualification: tournoi?.date_qualification,
      date_tableau_principal: toDateT(tournoi?.date_tableau_principal),
      formule_sportive_qualification: tournoi?.formule_sportive_qualification,
      formule_sportive_tableau_principal: tournoi?.formule_sportive_tableau_principal,
      modele_ballon: tournoi?.modele_ballon,
      membre_locaux: tournoi?.membre_locaux,
      prize_money_par_tableau: tournoi?.prize_money_par_tableau,
      repartition_prize_money: tournoi?.repartition_prize_money,
      tarif_inscription_par_equipe: tournoi?.tarif_inscription_par_equipe,
